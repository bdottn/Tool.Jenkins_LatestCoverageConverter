    ...
    <report>
      ...
      <data>
        ...
        <all name="all classes">
          ...
          <coverage type="class, %">
            <xsl:attribute name="value">
              <xsl:value-of select="$CoveredClasses div $TotalClasses * 100"/>%  (<xsl:value-of select="$CoveredClasses"/>/<xsl:value-of select="$TotalClasses"/>)
            </xsl:attribute>
          </coverage>
          <xsl:value-of select="$newline"/>
          ...
          <coverage type="method, %">
            <xsl:attribute name="value">
              <xsl:value-of select="$CoveredMethods div $TotalMethods * 100"/>%  (<xsl:value-of select="$CoveredMethods"/>/<xsl:value-of select="$TotalMethods"/>)
            </xsl:attribute>
          </coverage>
          <xsl:value-of select="$newline"/>
          ...
          <coverage type="block, %">
            <xsl:attribute name="value">
              <xsl:value-of select="$CoveredBlocks div $TotalBlocks * 100"/>%  (<xsl:value-of select="$CoveredBlocks"/>/<xsl:value-of select="$TotalBlocks"/>)
            </xsl:attribute>
          </coverage>
          <xsl:value-of select="$newline"/>
          ...
          <coverage type="line, %">
            <xsl:attribute name="value">
              <xsl:value-of select="$CoveredLines div $TotalLines * 100"/>%  (<xsl:value-of select="$CoveredLines"/>/<xsl:value-of select="$TotalLines"/>)
            </xsl:attribute>
          </coverage>
          <xsl:value-of select="$newline"/>
          ...
          <xsl:for-each select="//NamespaceTable">
            ...
            <package>
              ...
              <coverage type="class, %">
                <xsl:attribute name="value">
                  <xsl:value-of select="$PackageCoveredClasses div $PackageClasses * 100"/>%  (<xsl:value-of select="$PackageCoveredClasses"/>/<xsl:value-of select="$PackageClasses"/>)
                </xsl:attribute>
              </coverage>
              <xsl:value-of select="$newline"/>
              ...
              <coverage type="method, %">
                <xsl:attribute name="value">
                  <xsl:value-of select="$PackageCoveredMethods div $PackageMethods * 100"/>%  (<xsl:value-of select="$PackageCoveredMethods"/>/<xsl:value-of select="$PackageMethods"/>)
                </xsl:attribute>
              </coverage>
              <xsl:value-of select="$newline"/>
              ...
              <coverage type="block, %">
                <xsl:attribute name="value">
                  <xsl:value-of select="$PackageCoveredBlocks div $PackageBlocks * 100"/>%  (<xsl:value-of select="$PackageCoveredBlocks"/>/<xsl:value-of select="$PackageBlocks"/>)
                </xsl:attribute>
              </coverage>
              <xsl:value-of select="$newline"/>
              ...
              <coverage type="line, %">
                <xsl:attribute name="value">
                  <xsl:value-of select="$PackageCoveredLines div $PackageLines * 100"/>%  (<xsl:value-of select="$PackageCoveredLines"/>/<xsl:value-of select="$PackageLines"/>)
                </xsl:attribute>
              </coverage>
              <xsl:value-of select="$newline"/>
              ...
              <xsl:for-each select="//SourceFileNames">
                ...
                <xsl:if test="$Classes[child::Method/Lines[1]/SourceFileID = $SourceFileID]">
                  ...
                  <srcfile>
                    ...
                    <coverage type="class, %">
                      <xsl:attribute name="value">
                        <xsl:value-of select="$FileCoveredClasses div $FileClasses * 100"/>%  (<xsl:value-of select="$FileCoveredClasses"/>/<xsl:value-of select="$FileClasses"/>)
                      </xsl:attribute>
                    </coverage>
                    <xsl:value-of select="$newline"/>
                    ...
                    <coverage type="method, %">
                      <xsl:attribute name="value">
                        <xsl:value-of select="$FileCoveredMethods div $FileMethods * 100"/>%  (<xsl:value-of select="$FileCoveredMethods"/>/<xsl:value-of select="$FileMethods"/>)
                      </xsl:attribute>
                    </coverage>
                    <xsl:value-of select="$newline"/>
                    ...
                    <coverage type="block, %">
                      <xsl:attribute name="value">
                        <xsl:value-of select="$FileCoveredBlocks div $FileBlocks * 100"/>%  (<xsl:value-of select="$FileCoveredBlocks"/>/<xsl:value-of select="$FileBlocks"/>)
                      </xsl:attribute>
                    </coverage>
                    <xsl:value-of select="$newline"/>
                    ...
                    <coverage type="line, %">
                      <xsl:attribute name="value">
                        <xsl:value-of select="$FileCoveredLines div $FileLines * 100"/>%  (<xsl:value-of select="$FileCoveredLines"/>/<xsl:value-of select="$FileLines"/>)
                      </xsl:attribute>
                    </coverage>
                    <xsl:value-of select="$newline"/>
                    <!--<debug>
                    ...
                    <xsl:for-each select="$Classes[child::Method/Lines[1]/SourceFileID = $SourceFileID]">
                      ...
                      <class>
                        ...
                        <coverage type="class, %">
                          <xsl:attribute name="value">
                            <xsl:value-of select="$ClassCoveredClasses div $ClassClasses * 100"/>%  (<xsl:value-of select="$ClassCoveredClasses"/>/<xsl:value-of select="$ClassClasses"/>)
                          </xsl:attribute>
                        </coverage>
                        <xsl:value-of select="$newline"/>
                        ...
                        <coverage type="method, %">
                          <xsl:attribute name="value">
                            <xsl:value-of select="$ClassCoveredMethods div $ClassMethods * 100"/>%  (<xsl:value-of select="$ClassCoveredMethods"/>/<xsl:value-of select="$ClassMethods"/>)
                          </xsl:attribute>
                        </coverage>
                        <xsl:value-of select="$newline"/>
                        ...
                        <coverage type="block, %">
                          <xsl:attribute name="value">
                            <xsl:value-of select="$ClassCoveredBlocks div $ClassBlocks * 100"/>%  (<xsl:value-of select="$ClassCoveredBlocks"/>/<xsl:value-of select="$ClassBlocks"/>)
                          </xsl:attribute>
                        </coverage>
                        <xsl:value-of select="$newline"/>
                        ...
                        <coverage type="line, %">
                          <xsl:attribute name="value">
                            <xsl:value-of select="$ClassCoveredLines div $ClassLines * 100"/>%  (<xsl:value-of select="$ClassCoveredLines"/>/<xsl:value-of select="$ClassLines"/>)
                          </xsl:attribute>
                        </coverage>
                        <xsl:value-of select="$newline"/>
                        ...
                        <xsl:for-each select="$Classes[child::Method/Lines[1]/SourceFileID = $SourceFileID]/Method">
                          <method>
                            ...
                            <coverage type="method, %">
                              <xsl:attribute name="value">
                                <xsl:value-of select="$MethodCoveredMethods div $MethodMethods * 100"/>%  (<xsl:value-of select="$MethodCoveredMethods"/>/<xsl:value-of select="$MethodMethods"/>)
                              </xsl:attribute>
                            </coverage>
                            <xsl:value-of select="$newline"/>
                            ...
                            <coverage type="block, %">
                              <xsl:attribute name="value">
                                <xsl:value-of select="$MethodCoveredBlocks div $MethodBlocks * 100"/>%  (<xsl:value-of select="$MethodCoveredBlocks"/>/<xsl:value-of select="$MethodBlocks"/>)
                              </xsl:attribute>
                            </coverage>
                            <xsl:value-of select="$newline"/>
                            ...
                            <coverage type="line, %">
                              <xsl:attribute name="value">
                                <xsl:value-of select="$MethodCoveredLines div $MethodLines * 100"/>%  (<xsl:value-of select="$MethodCoveredLines"/>/<xsl:value-of select="$MethodLines"/>)
                              </xsl:attribute>
                            </coverage>
                            <xsl:value-of select="$newline"/>
